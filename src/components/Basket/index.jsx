...
const Basket = () => {
    ...
    let totalPrice = basket.reduce((acc, el) => {
        return acc+ +el.price * el.quently
    }, 0)
        ...
        <div className="container">
            {basket.length ?
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-[50px]">
                    ...
                    <h1 className="text-2xl font-bold text-center mt-{50px}">Total: {totalPrice}$</h1>
                </div> :
                <div className="w-[100%] flex item-center justify-center mt-[50px]">
                    <img src={BASKET} alt="" />
                </div>
            }
        </div>
